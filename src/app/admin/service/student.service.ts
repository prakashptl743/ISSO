...
getCustomersLarge(eventValue,schoolvalue) {
  ...
  let str =this.serverUrl+'student/loadStudentlList/' + eventValue +'/' +schoolvalue;
...
//  );
 ...
 return this.http.post<any>(this.serverUrl + 'student/loadGlobalStudentlList/',formData)
 .pipe(
   catchError(this.handleError)
 );
...
//  return this.http.get('student/loadSchoolList/')
//  .toPromise()
...
saveStudentData(studentInfo) {
 // console.log('Data in service'+JSON.stringify(schoolInfo));
  return this.http.post<any>(this.serverUrl + 'student/addNewStudent/',studentInfo)
  .pipe(
    catchError(this.handleError)
  );
...
updateStudentData (studentInfo) {
  return this.http.post<any>(this.serverUrl + 'student/updateStudent',studentInfo)
  .pipe(
    catchError(this.handleError)
  );
}
