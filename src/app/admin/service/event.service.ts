...
getEventlList() {
      return this.http.get(this.serverUrl + 'event/eventList').pipe(
...
getGamelList() {
  return this.http.get(this.serverUrl + 'event/gameList').pipe(
    catchError(this.handleError)
);
}
...
getUpcomingEventlList() {
  return this.http.get(this.serverUrl + 'event/upcomingeventList').pipe(
    catchError(this.handleError)
);
}

saveEventData(Blog) { 
  return this.http.post<any>(this.serverUrl + 'event/addNewEvent',Blog)
  .pipe(
    catchError(this.handleError)
  );
}
saveUpcomingEventData(Blog) {
  return this.http.post<any>(this.serverUrl + 'event/addUpcomingEvent',Blog)
  .pipe(
    catchError(this.handleError)
  );
}
deleteEvent(id: number) {
  return this.http.delete(this.serverUrl + 'event/deleteEvent/' + id).pipe(
    catchError(this.handleError)
  );
}

deleteUpcomingEvent(id: number) {
  return this.http.delete(this.serverUrl + 'event/deleteUpcomingEvent/' + id).pipe(
    catchError(this.handleError)
  );
}
