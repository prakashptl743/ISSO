...
changeWebStatus(id, webData) { 
  ...
  return this.http.post<any>(this.serverUrl + str, webData)
  .pipe(
    catchError(this.handleError)
  )
}
...
saveSchoolZone(schoolId,zoneVal) {
 ...
 return this.http.post<any>(this.serverUrl + str,zoneVal)
 .pipe(
   catchError(this.handleError)
 );
}
...
schoolRegistration(schoolInfo) {
  return this.http.post<any>(this.serverUrl + 'schoolRegistration/addNewSchool',schoolInfo)
 .pipe(
   catchError(this.handleError)
 );
}
...
//  );
 ...
 return this.http.post<any>(`${this.serverUrl}school/verifyEmail`, {email: eventValue})
 .pipe(map(user => {
  return user; 
