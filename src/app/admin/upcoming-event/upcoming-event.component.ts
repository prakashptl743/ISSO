...
getSchoolData(){
  this.showspinner = true;
      this.eventService.getUpcomingEventlList().subscribe(response => {
        if(response!=="") {
      ...
      if(id == '') {
        ...
        res => {
            if (res.status === 'error') {
              ...
              this.messageService.add({key: 'custom', severity:'success', summary: 'Upcoming event data added successfully'});
      ...
      this.eventService.editUpcomingEventData(id,formData).subscribe(
        res => {
            if (res.status === 'error') { 
              ...
              this.messageService.add({key: 'custom', severity:'success', summary: 'Upcoming Event Data Updated Successfully'});
            }
          this.display =false
          this.getSchoolData();
        },
