...
filterGame(gameData,callFrom) {
  ...
  if(this.gameFiletrType !=="") {
    this.showspinner = true;
      this.gameService.getGamesByType(this.gameFiletrType).subscribe(response => {
...
onSubmit() {
      ...
      formData.append('gameDescription', this.gameForm.get('gameDescription').value);
      ...
      formData.append('minElevengirls', this.gameForm.get('minElevengirls').value);
      formData.append('fourteen_boys', this.gameForm.get('fourteen_boys').value);
      formData.append('minfourteenboys', this.gameForm.get('minfourteenboys').value);
      formData.append('fourteen_girls', this.gameForm.get('fourteen_girls').value);
      formData.append('minfourteengirls', this.gameForm.get('minfourteengirls').value);
      formData.append('sixteen_boys', this.gameForm.get('sixteen_boys').value);
      formData.append('minsixteenboys', this.gameForm.get('minsixteenteenboys').value); //minsixteenteenboys
      formData.append('sixteen_girls', this.gameForm.get('sixteen_girls').value);
      formData.append('minsixteengirls', this.gameForm.get('minsixteengirls').value);
      formData.append('seventeen_boys', this.gameForm.get('seventeen_boys').value);
      formData.append('minSeventeenboys', this.gameForm.get('minSeventeenboys').value);
      formData.append('seventeen_girls', this.gameForm.get('seventeen_girls').value);
      formData.append('minSeventeengirls', this.gameForm.get('minSeventeengirls').value);
      formData.append('ninteen_boys', this.gameForm.get('ninteen_boys').value);
      formData.append('minNinteenboys', this.gameForm.get('minNinteenboys').value);
      formData.append('ninteen_girls', this.gameForm.get('ninteen_girls').value);
      formData.append('minNinteengirls', this.gameForm.get('minNinteengirls').value);
      ...
      if(gameId == '') {
        ...
        res => {
            if (res.status === 'error') {
              ...
              this.messageService.add({key: 'custom', severity:'success', summary: 'New Game data Added Successfully'});
      ...
      this.gameService.editGameData(gameId,formData).subscribe(
        res => {
            if (res.status === 'error') { 
              ...
              this.messageService.add({key: 'custom', severity:'success', summary: 'Game Data Updated Successfully'});
...
deleteSchoolData(event: Event, schoolData: Game) {
    ...
    this.confirmation.confirm({
      ...
      accept: () => { this.deleteGame(schoolData); },
    });
}
...
deleteGame(School) {
  ...
  this.gameService.deleteGame(gameId).subscribe(
   res => {
     ...
     //    this.messageService.add({severity:'error', summary: 'Error Message', detail:'Validation failed'});
     //  } else {
         this.messageService.add({key: 'custom', severity:'success', summary: 'Game Data Deleted Successfully'});
